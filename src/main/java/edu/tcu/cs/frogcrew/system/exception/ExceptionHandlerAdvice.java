...
public class ExceptionHandlerAdvice {
    ...
    Result handleNotFoundException(ObjectNotFoundException ex) {
    ...
    Result handleObjectAlreadyExistsException(ObjectAlreadyExistsException ex) {
    ...
    Result handleAccessDeniedException(AccountStatusException ex) {
